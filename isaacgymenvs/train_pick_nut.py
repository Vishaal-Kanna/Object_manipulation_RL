from object_manipulation_cube_pick_nut import ObjManipulationCube
...
env = ObjManipulationCube('runs/nut', cfg, rl_device='cuda:0', sim_device='cuda:0', graphics_device_id=0, headless=False, virtual_screen_capture=False, force_render=True)
...
eval_callback = EvalCallback(env, best_model_save_path='./logs/nut',
                             log_path='./logs/nut', eval_freq=10000)
