from object_manipulation_cube_pick_MT_1 import ObjManipulationCube
...
env = ObjManipulationCube('runs/Obj_Man_MT', [1, 2, 3, 4, 5], cfg, rl_device='cuda:0', sim_device='cuda:0', graphics_device_id=0, headless=False, virtual_screen_capture=False, force_render=True)
