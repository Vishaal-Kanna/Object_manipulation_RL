...
eval_callback = EvalCallback(env, best_model_save_path='./logs/Obj_Man_MT',
                             log_path='./logs/Obj_Man_MT', eval_freq=10000)
...
if test==False:
    ...
    model = TQC.load("/home/vishaal/Downloads/filesfrommultitasktraining/best_model.zip", env=env)
