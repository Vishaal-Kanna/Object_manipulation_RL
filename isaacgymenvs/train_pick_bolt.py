from object_manipulation_cube_pick_bolt import ObjManipulationCube
...
env = ObjManipulationCube('runs/bolt', cfg, rl_device='cuda:0', sim_device='cuda:0', graphics_device_id=0, headless=False, virtual_screen_capture=False, force_render=True)
...
eval_callback = EvalCallback(env, best_model_save_path='./logs/bolt',
                             log_path='./logs/bolt', eval_freq=10000)
